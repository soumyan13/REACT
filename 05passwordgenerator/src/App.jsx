...
function App() {
  ...
  const copyPasswordToClipboard = useCallback(() => {
    ...
    passwordRef.current?.setSelectionRange(0, 3); //Here,  it set the range
    ...
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-800'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <button onClick={copyPasswordToClipboard} className='outline-none bg-blue-800 text-white px-3 py-0 shrink-0'>copy</button>
        </div>
        <div className='flex text-sm gap-x-2'>
          ...
          <div className='flex items-center gap-x-1'>
            ...
            <lebel htmlFor="xharInput">Characters</lebel>
          </div>
        </div>
      </div>
    </>
